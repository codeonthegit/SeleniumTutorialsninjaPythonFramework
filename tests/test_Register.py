...
class TestRegister:
    def test_register_with_mandatory_fields(self):
        ...
        register_page.enter_last_name("Here")
    ...
    def test_register_with_duplicate_email(self):
        ...
        register_page.enter_first_name("Test")
        register_page.enter_last_name("Here")
        register_page.enter_email("Testhere@yopmail.com")
        register_page.enter_telephone("1234567890")
        register_page.enter_password("12345")
        register_page.enter_password_confirm("12345")
        register_page.select_yes_radio_button()
    ...
    def test_register_without_entering_any_fields(self):
        ...
        assert register_page.retrieve_email_warning().__eq__(expected_email_warning_message)
        ...
        assert register_page.retrieve_password_warning().__eq__(expected_password_warning_message)
