...
class TestRegister(BaseTest):
    def test_register_with_mandatory_fields(self):
        ...
        account_success_page = register_page.register_an_application("Test","Here",self.generate_email_with_time_stamp(),"1234567890","12345","12345","no","select")
    ...
    def test_register_with_all_fields(self):
        home_page = HomePage(self.driver)
        register_page = home_page.navigate_to_register_page()
        account_success_page = register_page.register_an_application("Test","Here",self.generate_email_with_time_stamp(),"1234567890","12345","12345","yes","select")
        expected_heading_text = "Your Account Has Been Created!"
        assert account_success_page.retrieve_account_creation_message().__eq__(expected_heading_text)
    ...
    def test_register_with_duplicate_email(self):
        home_page = HomePage(self.driver)
        register_page = home_page.navigate_to_register_page()
        register_page.register_an_application("Test","Here","Testhere@yopmail.com","1234567890","12345","12345","yes","select")
    ...
    def test_register_without_entering_any_fields(self):
        home_page = HomePage(self.driver)
        register_page = home_page.navigate_to_register_page()
        register_page.register_an_application("","","","","","","no","no")
