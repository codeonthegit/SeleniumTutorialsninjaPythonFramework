...
class RegisterPage(BasePage):
    ...
    def enter_password_confirm(self,password_confirm_text):
        self.type_into_element(password_confirm_text,"confirm_password_field_id",self.confirm_password_field_id)
    ...
    def register_an_application(self,first_name_text,last_name_text,email_text,telephone_text,password_text,password_confirm_text,yes_or_no,privacy_policy):
